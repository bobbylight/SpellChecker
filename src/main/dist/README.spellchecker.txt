...
text files, the entire file is spell-checked.  Spelling errors are
squiggle-underlined with the color of your choosing, and hovering the mouse
over a misspelled word displays a tooltip with suggested fixes (if any).
...
for more information about the Jazzy library.  Any modifications to the
original source can be found by searching for "robert:".
